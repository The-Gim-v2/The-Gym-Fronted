  ...
  <HeadingMember>
    <div class="saas-dashboard-wrapper">
      <main class="dashboard-main-container">
        ...
        <!-- HEADER -->
        <div class="section-header-box" id="tutorial-dashboard-header">
          ...
          <div class="gym-search-bar" id="tutorial-dashboard-search">
        ...
        <!-- SECCIÓN 1: MI SEDE -->
        <div class="category-section" v-if="filteredMiSede.length" id="tutorial-my-headquarters">
        ...
        <div class="category-section" v-if="filteredLocales.length" id="tutorial-other-headquarters">
          <div class="category-header">
        ...
        <div class="category-section" >
          ...
          <div v-for="(ents, estado) in filteredNacionalesPorEstado" :key="estado" class="state-subsection">
            ...
            <div class="trainers-grid-container"id="tutorial-national-network">
